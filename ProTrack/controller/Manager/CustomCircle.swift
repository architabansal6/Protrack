...
class CustomCircle: UIView {
    ...
    //    { println("button")
    //        var description:TaskViewController = TaskViewController()
    //        description.performSegueWithIdentifier("description", sender: self)
    //        description.navigationController?.pushViewController(TaskViewController(), animated: true)
    //    }
