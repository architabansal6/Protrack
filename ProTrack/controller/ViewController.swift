...
class ViewController: UIViewController,UITextFieldDelegate{
    ...
    @IBAction func btnLogin()
    {
            ...
            
        {
            ...
            var url:NSURL = NSURL(string: "https://TelcoApp.mybluemix.net/login")!
            var request:NSMutableURLRequest=NSMutableURLRequest(URL: url)
            
            var keys:NSArray=NSArray(objects: "_id","password","name","role")
            var objects:NSArray=NSArray(objects: txtMobileNo.text,txtPasswrd.text,"Ram","Customer")
            ...
            //Get Method
            var url1:NSURL = NSURL(string: "https://TelcoApp.mybluemix.net/login1/")!
